...
<head>
    ...
    <script src="{{ asset('/amaze/js/echarts.min.js') }}"></script>
</head>
...
<header class="am-topbar am-topbar-inverse admin-header">
    <div class="am-topbar-brand">
        <a href="/" class="tpl-logo">
            <img src="{{ asset('/amaze/img/logo.png') }}" style="width: 70px;" alt="">
        </a>
    </div>
    ...
    <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
        ...
        <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
            ...
            <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                ...
                <ul class="am-dropdown-content tpl-dropdown-content">
                    ...
                    <li>
                      ...
                      <img src="{{ asset('/amaze/img/user02.png') }}" alt=""> </span>
                      ...
                      <span class="tpl-dropdown-content-from"> 禁言小张 </span>
                        ...
                        <a href="#" class="tpl-dropdown-content-message">
                                <span class="tpl-dropdown-content-photo">
                      <img src=""{{ asset('/amaze/img/user03.png') }}" alt=""> </span>
                                <span class="tpl-dropdown-content-subject">
            ...
            <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                <a class="am-dropdown-toggle tpl-header-list-link" href="javascript:;">
                    <span class="tpl-header-list-user-nick">禁言小张</span><span class="tpl-header-list-user-ico"> <img src="{{ asset('/amaze/img/user01.png') }}"></span>
                </a>
...
<script src="{{ asset('/amaze/js/lazyload.js') }}"></script>
<!--layer-->
<script src="{{ asset('/layer/layer/layer.js') }}"></script>
<link rel="stylesheet" href="{{ asset('/layer/layer/skin/default/layer.css') }}">
<script src="http://www.jq22.com/demo/tuupola-jquery_lazyload/jquery.lazyload.js"></script>
