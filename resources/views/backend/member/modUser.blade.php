            ...
            <div class="am-u-sm-12 am-u-md-10">
                <form class="am-form am-form-horizontal" id="myForm">
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" id="nickname" name="nickname" placeholder="昵称 / Nickname" value="{{ $find->nickname }}">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="email" id="email" name="email" placeholder="输入你的电子邮件 / Email" value="{{ $find->email }}">
                            <small>邮箱你懂得...</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" id="password" name="password" placeholder="密码 / Password" value="{{ $find->password }}">
                            <small>输入你的名字，让我们记住你。</small>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="tel" id="phone" name="phone" placeholder="输入你的电话号码 / Phone" value="{{ $find->phone }}">
                        </div>
                    </div>
...
<script>
    function save()
    {
        ...
        $.ajax({
            type: "POST",
            url: '{{ url('/Backend/Member/modUserServer') }}',
