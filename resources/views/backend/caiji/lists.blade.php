        ...
        <div class="tpl-block">
            ...
            @endif
                ...
                <div class="am-u-sm-12">
                    <form class="am-form" action='{{ url('/Backend/Caiji/begin') }}' method="post">
                        {{csrf_field()}}
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>1</td>
                                    <td><input type="text" name="url" value="http://v.soku.daicuo.cc/video/28913.html" class="url1"></td>
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a class="am-btn am-btn-default am-btn-xs am-text-secondary"><input type="submit" value="采集"></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
