                ...
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" id="myForm" method="post" enctype="multipart/form-data" action="{{ url('/Backend/Video/upload') }}">
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="user-name" placeholder="标题" name="title" value="{{ $find['title'] }}">
                                <small  id="aa"></small>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                ...
                                <div class="files"></div>
                                <div id="showimg"><img src="{{ asset('../storage/app/' . $find['thumb']) }}" alt=""></div>
                            </div>
                        </div>
                        {{csrf_field()}}
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="user-name" placeholder="输入完整的url地址" name="content" value="{{ $find['content'] }}">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <textarea class="" rows="5" id="user-intro" placeholder="250字以内写出你的一生..."  name="description">{{ $find['description'] }}</textarea>
                                <small id="description"></small>
                            </div>
                        </div>

                        <input type="hidden" name="pic" id="pic" value="{{ $find['thumb'] }}">
...
@section('my-js')
    ...
    <script type="text/javascript">
        ...
        function upload()
        {
            $.ajax({
                type: "POST",
                url: '{{ url('/Backend/Video/modVideo2') }}' ,
                headers: { 'X-CSRF-TOKEN' : '{{ csrf_token() }}' },
                dataType: 'json',
                cache: false,
